...
export const GUIDES: GuideMeta[] = [
  ...
  },
  {
    ...
    teaser: {
      ru: "Где на Encar спрятаны страховая история, пробег и диагностика — и как прочитать их без знания корейского.",
  ...
  },
  {
    ...
    teaser: {
      ru: "Страховой отчёт, протокол осмотра, аукционный лист: что показывает каждый документ и каким цифрам верить.",
  ...
  },
  {
    ...
    teaser: {
      ru: "Бесплатные способы проверить корейское авто перед покупкой — и что даёт наш бесплатный мини-отчёт.",
  ...
  },
  {
    ...
    teaser: {
      ru: "Полный маршрут: подбор и проверка в Корее, доставка, таможенные платежи КЗ и первичная регистрация.",
  ...
  },
  {
    ...
    teaser: {
      ru: "Пошагово: от выбора объявления до выкупа, оплаты и отправки — и почему без представителя в Корее не обойтись.",
