...
export const CATEGORIES: Record<PartCategory, { title: string; plural: string; description: string }> = {
  'zadnie-fonari': {
    ...
    description:
      'Оригинальные задние фонари с авторазборок Южной Кореи. Поиск по OEM-артикулу, марке и модели, доставка по России.',
  },
  'protivotumannye-fary': {
    title: 'Противотуманная фара',
    plural: 'Противотуманные фары',
    description:
      'Оригинальные противотуманные фары из Южной Кореи. Поиск по OEM-артикулу, марке и модели, доставка по России.',
  },
};
