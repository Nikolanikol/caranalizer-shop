...
const PAYMENTS = [
  { icon: QrCode, title: 'СБП по QR-коду', text: 'Перевод по системе быстрых платежей российского банка.' },
  { icon: CreditCard, title: 'Карта РФ', text: 'Оплата картой российского банка, в том числе МИР.' },
  {
    icon: Building2,
    title: 'Безналичный расчёт',
    text: 'Для юридических лиц и ИП — по счёту. Реквизиты и документы присылает менеджер.',
  },
];
